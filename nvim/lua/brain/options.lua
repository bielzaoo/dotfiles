...
vim.opt.softtabstop = 2 -- Number of spaces to insert for a tab (in insert mode)
vim.opt.autoindent = true -- Copy indent from the current line when starting a new line
vim.opt.smartindent = true -- Smarter indenting for specific languages (like C/Python)
